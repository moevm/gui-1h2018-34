...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ToMainMenu.setMaximumSize(QtCore.QSize(400, 60))
        self.ToMainMenu.setObjectName("ToMainMenu")
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(330, 20, 102, 27))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(190, 80, 391, 361))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Сложность"))
        self.pushButton.setText(_translate("Form", "Легко"))
        self.pushButton_2.setText(_translate("Form", "Средне"))
        self.pushButton_3.setText(_translate("Form", "Сложно"))
